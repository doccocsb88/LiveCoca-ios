...
//@property (nonatomic, strong) GPUImageMovie *gpuIMovie;
////@property (nonatomic, strong) GPUImageTransformFilter *movieFilter;
//@end
//
...
//            [self.gpuIMovie startProcessing];
//            
...
//        return _movieWriter;
//}
//-(GPUImageMovie *)gpuIMovie{
//    if (!_gpuIMovie) {
//        //        NSURL *sampleURL = [[NSURL alloc] initWithString:@"http://techslides.com/demos/sample-videos/small.mp4"];
//        NSURL *sampleURL = [[NSBundle mainBundle] URLForResource:@"galaxy" withExtension:@"mp4"];
//        if (sampleURL == NULL) {
//            NSLog(@"dkm null roi");
//        }else{
//            NSLog(@"dkm %@",sampleURL.absoluteString);
//            
//        }
//        //        NSURL *filepath = [NSURL fileURLWithPath:/*save file path*/];
//        AVPlayerItem *player = [AVPlayerItem playerItemWithURL:sampleURL];
//        
//        //        _gpuIMovie = [[GPUImageMovie alloc] initWithPlayerItem:player];
//        _gpuIMovie = [[GPUImageMovie alloc] initWithURL:sampleURL];
//        
//        _gpuIMovie.playAtActualSpeed = YES;
//        [_gpuIMovie setShouldRepeat:YES];
//    }
//    return _gpuIMovie;
//}
//-(GPUImageTransformFilter *)movieFilter{
//    if (!_movieFilter) {
//        _movieFilter = [[GPUImageTransformFilter alloc] init];
//        _movieFilter.affineTransform = CGAffineTransformConcat(CGAffineTransformMakeTranslation(1, 1.5), CGAffineTransformMakeScale(0.3, 0.3));
//        
//    }
//    return _movieFilter;
//}
...
//        [self.gpuIMovie removeAllTargets];
//        [self.movieFilter removeAllTargets];
//        if (self.beautyFace) {
...
//        //    [self.gpuIMovie addTarget:self.movieFilter];
//        ////    [self.filter addTarget:self.movieFilter];
//        //    [self.movieFilter addTarget:self.gpuImageView];
//        //    [self.filter addTarget:movieFilter];
//        //    [self.uiElementInput addTarget:movieFilter];
//        
